...
void GLTFModel::LoadMesh(tinygltf::Model& model, tinygltf::Mesh& mesh, tinygltf::Node& node)
{
...
void GLTFModel::LoadModelNodes(tinygltf::Node& node)
{
	...
	{
		LoadMesh(model, model.meshes[node.mesh], node);
	}
...
void GLTFModel::Loader()
{
	...
	data.GLTFPrimitiveList = GLTFPrimitiveList;
}