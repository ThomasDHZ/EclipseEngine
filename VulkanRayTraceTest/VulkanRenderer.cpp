...
void VulkanRenderer::StartUp()
{
	...
	SwapChain = VulkanSwapChain(VulkanWindow::GetWindowPtr(), Device, PhysicalDevice, Surface);
...
void VulkanRenderer::RebuildSwapChain()
{
	...
	SwapChain.RebuildSwapChain(VulkanWindow::GetWindowPtr(), Device, PhysicalDevice, Surface);
}
