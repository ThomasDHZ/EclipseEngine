...
DrawLinePipeline::DrawLinePipeline(const VkRenderPass& renderPass, BuildGraphicsPipelineInfo& buildGraphicsPipelineInfo) : GraphicsPipeline()
{
...
void DrawLinePipeline::SetUpDescriptorBindings(BuildGraphicsPipelineInfo& buildGraphicsPipelineInfo)
{
    SubmitDescriptorSet(buildGraphicsPipelineInfo.DescriptorBindingList);

}

void DrawLinePipeline::SetUpShaderPipeLine(const VkRenderPass& renderPass)
{
    ...
    viewport.x = 0.0f;
    viewport.y = 0.0f;
    viewport.width = (float)VulkanRenderer::GetSwapChainResolution().width;
    viewport.height = (float)VulkanRenderer::GetSwapChainResolution().height;
    viewport.minDepth = 0.0f;
    viewport.maxDepth = 1.0f;

    VkRect2D scissor{};
    scissor.offset = { 0, 0 };
    scissor.extent = VulkanRenderer::GetSwapChainResolution();
...
void DrawLinePipeline::UpdateGraphicsPipeLine(const VkRenderPass& renderPass, BuildGraphicsPipelineInfo& buildGraphicsPipelineInfo)
{
