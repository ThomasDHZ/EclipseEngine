...
GLTF_BRDFRenderPass::GLTF_BRDFRenderPass() : RenderPass()
{
}
...
void GLTF_BRDFRenderPass::BuildRenderPass(uint32_t textureSize)
{
...
void GLTF_BRDFRenderPass::BuildRenderPassPipelines()
{
