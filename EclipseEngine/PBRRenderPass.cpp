...
void PBRRenderPass::BuildRenderPass(std::string& renderPass2, PBRRenderPassTextureSubmitList& textures)
{
...
void PBRRenderPass::BuildRenderPassPipelines(PBRRenderPassTextureSubmitList& textures)
{
    ...
    //Instanced Renderers
    {
        ...
        PBRInstancePipeline = JsonGraphicsPipeline("/Pipelines/PBRInstancePipeline.txt", bindingDescriptions, attributeDescriptions, renderPass, ColorAttachmentList, SampleCount, sizeof(SceneProperties), textures);
        WireframeInstancePipeline = JsonGraphicsPipeline("/Pipelines/WireframeInstancePipeline.txt", bindingDescriptions, attributeDescriptions, renderPass, ColorAttachmentList, SampleCount, sizeof(SceneProperties));
    }
}
...
VkCommandBuffer PBRRenderPass::Draw()
{
    ...
    //ColorTexture->UpdateImageLayout(commandBuffer, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
    //BloomTexture->UpdateImageLayout(commandBuffer, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
    //RenderedTexture->UpdateImageLayout(commandBuffer, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
    //RenderedBloomTexture->UpdateImageLayout(commandBuffer, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
