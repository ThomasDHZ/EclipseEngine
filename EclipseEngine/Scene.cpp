...
void Scene::Update()
{
  ...
  // pbrRenderer.Update();
    ...
    rayTraceRenderer.updateUniformBuffers();
}
...
void Scene::BuildRenderers()
{
	...
	rayTraceRenderer = RayTraceRenderer(VulkanRenderer::GetSwapChainResolution().width, VulkanRenderer::GetSwapChainResolution().height);
