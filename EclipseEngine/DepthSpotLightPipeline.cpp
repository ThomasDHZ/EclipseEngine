...
DepthSpotLightPipeline::DepthSpotLightPipeline()
{
}
...
void DepthSpotLightPipeline::InitializePipeline(PipelineInfoStruct& pipelineInfoStruct)
{
    ...
    PipelineShaderStageList.emplace_back(CreateShader(BaseShaderFilePath + "DepthSpotLightShaderVert.spv", VK_SHADER_STAGE_VERTEX_BIT));
    PipelineShaderStageList.emplace_back(CreateShader(BaseShaderFilePath + "DepthSpotLightShaderFrag.spv", VK_SHADER_STAGE_FRAGMENT_BIT));
    ...
    AddStorageBufferDescriptorSetBinding(DescriptorBindingList, 4, GLTFSceneManager::GetSpotLightPropertiesBuffer()[0]);
