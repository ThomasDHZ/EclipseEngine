...
struct SceneData {
    ...
    RTXDirectionalLight dlight;
    alignas(16) glm::vec3 viewPos;
    RTXPointLight plight;
...
public:
    ...
    void createBottomLevelAccelerationStructure(RayTraceModel& model, RayTraceMesh& mesh);
