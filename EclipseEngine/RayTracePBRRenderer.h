...
public:
    ...
    RTXVulkanBuffer vertexBuffer;
    RTXVulkanBuffer indexBuffer;
    uint32_t indexCount;
    RTXVulkanBuffer transformBuffer;
    RTXVulkanBuffer transformBuffer2;
    std::vector<VkRayTracingShaderGroupCreateInfoKHR> RayTraceShaders{};
    RTXVulkanBuffer raygenShaderBindingTable;
    RTXVulkanBuffer missShaderBindingTable;
    RTXVulkanBuffer hitShaderBindingTable;
    ...
    RayTraceRenderer();
    RayTraceRenderer(uint32_t WIDTH, uint32_t HEIGHT);
    ~RayTraceRenderer();
