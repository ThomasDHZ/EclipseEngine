...
void RayTracingPipeline::SetUp(std::vector<DescriptorSetBindingStruct>& DescriptorBindingList)
{
...
void RayTracingPipeline::UpdateGraphicsPipeLine(std::vector<DescriptorSetBindingStruct>& DescriptorBindingList)
{
