...
void Model::UpdateVertexPropertiesBuffer()
{
	VkDescriptorBufferInfo vertexPropertiesBufferInfo = {};
	vertexPropertiesBufferInfo.buffer = VertexBuffer->GetBuffer();
	vertexPropertiesBufferInfo.offset = 0;
	vertexPropertiesBufferInfo.range = VK_WHOLE_SIZE;

	VertexPropertiesBuffer = vertexPropertiesBufferInfo;
}

void Model::UpdateIndexPropertiesBuffer()
{
	VkDescriptorBufferInfo indexPropertiesBufferInfo = {};
	indexPropertiesBufferInfo.buffer = IndexBuffer->GetBuffer();
	indexPropertiesBufferInfo.offset = 0;
	indexPropertiesBufferInfo.range = VK_WHOLE_SIZE;

	IndexPropertiesBuffer = indexPropertiesBufferInfo;
}
