...
void Renderer2DPipeline::InitializePipeline(PipelineInfoStruct& pipelineInfoStruct)
{
    ...
    PipelineShaderStageList.emplace_back(CreateShader(BaseShaderFilePath + "Renderer2DVert.spv", VK_SHADER_STAGE_VERTEX_BIT));
    PipelineShaderStageList.emplace_back(CreateShader(BaseShaderFilePath + "Renderer2DFrag.spv", VK_SHADER_STAGE_FRAGMENT_BIT));
