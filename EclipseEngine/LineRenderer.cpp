...
LineRenderer::LineRenderer(std::vector<LineVertex> VertexList, uint64_t GameObjectID) : Component(GameObjectID, ComponentType::kLineRenderer, ComponentSubType::kRenderedObject)
{
...
LineRenderer::LineRenderer(glm::vec3 StartPoint, glm::vec3 EndPoint, uint64_t GameObjectID) : Component(GameObjectID, ComponentType::kLineRenderer, ComponentSubType::kRenderedObject)
{
...
LineRenderer::LineRenderer(nlohmann::json& json, uint64_t GameObjectID) : Component(GameObjectID, json, ComponentSubType::kRenderedObject)
{
