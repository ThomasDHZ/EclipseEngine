...
DrawLinePipeline::DrawLinePipeline(const VkRenderPass& renderPass) : GraphicsPipeline()
{
...
void DrawLinePipeline::UpdateGraphicsPipeLine(const VkRenderPass& renderPass)
{
