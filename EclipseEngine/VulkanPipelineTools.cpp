...
void VulkanPipelineTools::LoadDescriptorSets(nlohmann::json& json)
{
    ...
    for (int x = 0; x < BindingList.size(); x++)
    {
        switch (BindingList[x])
        {
            case kMeshPropertiesDescriptor: AddUniformBufferDescriptorSetBinding(DescriptorBindingList, x, GLTFSceneManager::GetGameObjectPropertiesBuffer()); break;
            case kModelTransformDescriptor: AddUniformBufferDescriptorSetBinding(DescriptorBindingList, x, GLTFSceneManager::GetGameObjectTransformBuffer()); break;
            case kMaterialDescriptor: AddUniformBufferDescriptorSetBinding(DescriptorBindingList, x, GLTFSceneManager::GetMaterialPropertiesBuffer()); break;
            ...
            case kSunLightDescriptor: AddUniformBufferDescriptorSetBinding(DescriptorBindingList, x, GLTFSceneManager::GetSunLightPropertiesBuffer()); break;
            case kDirectionalLightDescriptor: AddUniformBufferDescriptorSetBinding(DescriptorBindingList, x, GLTFSceneManager::GetDirectionalLightPropertiesBuffer()); break;
            case kPointLightDescriptor: AddUniformBufferDescriptorSetBinding(DescriptorBindingList, x, GLTFSceneManager::GetPointLightPropertiesBuffer()); break;
            case kSpotLightDescriptor: AddUniformBufferDescriptorSetBinding(DescriptorBindingList, x, GLTFSceneManager::GetSpotLightPropertiesBuffer()); break;
...
VkPipelineShaderStageCreateInfo VulkanPipelineTools::LoadPipelineShaderStageCreateInfo(nlohmann::json& json)
{
    ...
    {
        PipelineShaderStageCreateInfo.module = VulkanRenderer::CompileHLSLShader(fileName, json["stage"]);
    }
