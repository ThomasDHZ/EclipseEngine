...
void EnvironmentToCubeRenderPass::BuildRenderPassPipelines()
{
    ...
    EnvironmentToCubeRenderPassPipeline = JsonGraphicsPipeline("/Pipelines/EnvironmentToCubePipeline.txt", SkyboxVertexLayout::getBindingDescriptions(), SkyboxVertexLayout::getAttributeDescriptions(), renderPass, ColorAttachmentList, SampleCount, 0);
}
