...
//}
//
//GridRenderer3D::GridRenderer3D(const std::string Name, int GridSize, float GridSpacing) : GameObject(Name, kGridRenderer3D)
//{
//	GridObject = std::make_shared<LineMesh3D>(LineMesh3D(GridSize, GridSize, GridSize, GridSpacing, GridSpacing, GridSpacing));
//}
//
//GridRenderer3D::GridRenderer3D(const std::string Name, int GridSizeX, int GridSizeY, int GridSizeZ, float GridSpacingX, float GridSpacingY, float GridSpacingZ) : GameObject(Name, kGridRenderer3D)
//{
